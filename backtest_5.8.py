...
def run_v593_pure_backtest():
    print("==========================================================")
    print("🚀 [Ver 5.9.3-Pure] 순수 4슬롯 자금 분산형 퀀트 엔진 가동")
    print("✅ 오직 종목 수만 3개 -> 4개 확장 (RSI 등 일체 필터 없음)")
    print("✅ Ver 5.9.1 완화된 익절 룰 (+30% / -10%) 동일 적용")
    print("==========================================================")
    ...
    for idx, date in enumerate(all_dates):
        ...
        if all_candidates:
            ...
            top_4_tickers = [c['ticker'] for c in all_candidates[:4]]
            
            for t in list(positions.keys()):
                if t in top_4_tickers or t in [o['ticker'] for o in pending_orders]: continue
                
                available_news = [c for c in all_candidates[:4] if c['ticker'] not in positions]
            ...
            # 💡 RSI 조건 필터를 삭제하여 순수하게 진입 신호가 나면 다 잡음
    ...
    print("\n==========================================================")
    print("      🎯 [최종 성적표] Ver 5.9.3-Pure 4슬롯 결과")
    print("==========================================================")
